        ...
        for settings in self.sticksParameters:
            ...
            for obj in self.drumRotKeyframes:
                ...
                for time, value, noteNumber, param in self.drumRotKeyframes[obj]:
                    ...
                    if value == DrumstickSettings.restValue:
                        obj.location[2] = oldZ
                    else:
                        obj.location[2] = (radians(value) / 20) + oldZ
        ...
        if self.sortNotesAlgorithim == "simple":
            ...
            for i, curNote in enumerate(self.midiTrack.notes):
                ...
                for ranking in sticksRanked:
                    ...
                    print(f"sec={curNote.timeOn} frames={secToFrames(curNote.timeOn)} {animLength=} mapRange={mapRangeLinear(velocity, settings.minVel, settings.maxVel, 0, 5)} {s}")
                ...
                if animLength >= 10 or i == len(settings.notesToPlay) - 1:
                    ...
                    drumstickKeyframeDict[obj].append(
                        BlenderKeyframe(
                            location=settings.homePosObj.location, 
                            rotation=settings.homePosObj.rotation_euler,
                            frame=secToFrames(curNote.timeOn + 3)
                        )
                    )
                    settings.homePos = True
                    pass
...
drums = file.findTrack("Drums")
# print(testTrack)

drumsticks = bpy.data.collections['Sticks']

settings = {
    "stickParameters": [
        DrumstickSettings(
            obj=bpy.data.objects['drumstick1LTarget'],
            drumstickModel=bpy.data.objects['drumstick1L'],
            gimbal=bpy.data.objects['drumstick1LGimbal'],
            homePosObj=bpy.data.objects['drumstick1L_homepos'],
            stickRotObj=bpy.data.objects['drumstick1LRot'],
            listenForNotes=[39, 42, 46, 47, 48, 49, 50, 51, 53],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.01,
            velocityThreshold=1
        ),
        DrumstickSettings(
            obj=bpy.data.objects['drumstick1RTarget'],
            drumstickModel=bpy.data.objects['drumstick1R'],
            gimbal=bpy.data.objects['drumstick1RGimbal'],
            homePosObj=bpy.data.objects['drumstick1R_homepos'],
            stickRotObj=bpy.data.objects['drumstick1RRot'],
            listenForNotes=[39, 47, 48, 49, 50, 51, 53],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.01,
            velocityThreshold=100000
        ),
        DrumstickSettings(
            obj=bpy.data.objects['drumstick1.5Target'],
            drumstickModel=bpy.data.objects['drumstick1.5'],
            gimbal=bpy.data.objects['drumstick1.5Gimbal'],
            homePosObj=bpy.data.objects['drumstick1.5_homepos'],
            stickRotObj=bpy.data.objects['drumstick1.5Rot'],
            listenForNotes=[39, 47, 48, 49, 50, 51, 53],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.01,
            velocityThreshold=100000
        ...
        DrumstickSettings(
            obj=bpy.data.objects['drumstick2LTarget'],
            drumstickModel=bpy.data.objects['drumstick2L'],
            gimbal=bpy.data.objects['drumstick2LGimbal'],
            homePosObj=bpy.data.objects['drumstick2L_homepos'],
            stickRotObj=bpy.data.objects['drumstick2LRot'],
            listenForNotes=[65, 66, 80, 81],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.01,
            velocityThreshold=10000
        ),
        DrumstickSettings(
            obj=bpy.data.objects['drumstick2RTarget'],
            drumstickModel=bpy.data.objects['drumstick2R'],
            gimbal=bpy.data.objects['drumstick2RGimbal'],
            homePosObj=bpy.data.objects['drumstick2R_homepos'],
            stickRotObj=bpy.data.objects['drumstick2RRot'],
            listenForNotes=[65, 66, 80, 81],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.01,
            velocityThreshold=10000
        ...
        DrumstickSettings(
            obj=bpy.data.objects['drumstick3LTarget'],
            drumstickModel=bpy.data.objects['drumstick3L'],
            gimbal=bpy.data.objects['drumstick3LGimbal'],
            homePosObj=bpy.data.objects['drumstick3L_homepos'],
            stickRotObj=bpy.data.objects['drumstick3LRot'],
            listenForNotes=[40, 41, 43, 45, 52, 55, 86, 87],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.001,
            velocityThreshold=10000
        ),
        DrumstickSettings(
            obj=bpy.data.objects['drumstick3RTarget'],
            drumstickModel=bpy.data.objects['drumstick3R'],
            gimbal=bpy.data.objects['drumstick3RGimbal'],
            homePosObj=bpy.data.objects['drumstick3R_homepos'],
            stickRotObj=bpy.data.objects['drumstick3RRot'],
            listenForNotes=[40, 41, 43, 45, 52, 55, 86, 87],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.001,
            velocityThreshold=10000
        ...
        DrumstickSettings(
            obj=bpy.data.objects['drumstick4Target'],
            drumstickModel=bpy.data.objects['drumstick4'],
            gimbal=bpy.data.objects['drumstick4Gimbal'],
            homePosObj=bpy.data.objects['drumstick4_homepos'],
            stickRotObj=bpy.data.objects['drumstick4Rot'],
            listenForNotes=[35, 36],
            targetCollection=bpy.data.collections['DrumsTargets'],
            animationLengthThreshold=0.1,
            velocityThreshold=10000
        ),
        # DrumstickSettings(
