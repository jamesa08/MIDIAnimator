...
impl BlendKeyframe {
    fn new(frame: f64, value: f64, data_path: &str, array_index: u32) -> Self {
        Self {
            frame,
            value,
    ...
    fn bare(frame: f64, value: f64) -> Self {
        Self {
            frame,
            value,
...
fn get_value(k1: &BlendKeyframe, k2: &BlendKeyframe, frame: f64) -> f64 {
...
fn interval<'a>(key_list: &'a [BlendKeyframe], frame: f64) -> (Option<&'a BlendKeyframe>, Option<&'a BlendKeyframe>) {
...
fn find_overlap(key_list1: &[BlendKeyframe], key_list2: &[BlendKeyframe]) -> Vec<BlendKeyframe> {
...
fn add_keyframes(inserted_keys: &mut Vec<BlendKeyframe>, next_keys: &mut Vec<BlendKeyframe>) {
