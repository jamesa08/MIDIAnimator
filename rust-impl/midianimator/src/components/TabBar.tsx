                    ...
                    <AnimatePresence initial={false}>
                        {tabs.map((tab) => (
                            <Reorder.Item
                                ...
                                className={`
                  relative flex items-center gap-1 px-3 h-full text-sm
                  cursor-pointer select-none border-r border-black
                  shrink-0 max-w-[160px] min-w-[80px]
                  ${tab.id === activeId ? "bg-white" : "bg-zinc-200 hover:bg-zinc-100"}
                `}
